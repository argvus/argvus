...
Temas dark usam `default.png`; Light usa `argvus-light.png`; Slate usa `argvus-dark-aether-slate.png`; e Dark Silver usa `argvus-dark-silver.png`. Variantes Normal e Float de cada família compartilham o mesmo wallpaper. Os wallpapers são entregues pelo pacote `argvus-appearance` em `/usr/share/backgrounds/argvus/`.
