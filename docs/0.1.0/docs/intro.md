...
* [Installation](/0.1.0/docs/install/) — add the repository, install, update and remove the desktop.
* [Themes](/0.1.0/docs/themes/) — theme families and accent colors.
* [Sessions](/0.1.0/docs/sessions/gdm/) — start ARGVUS from GDM or a TTY.
* [Calendar](/0.1.0/docs/calendar/) — the native Waybar calendar popup.
* [Removable Storage](/0.1.0/docs/storage/) — the Waybar storage module.
* [Packaging](/0.1.0/docs/packaging/) — package layout and publishing.
